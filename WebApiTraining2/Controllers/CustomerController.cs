...
namespace WebApiTraining2.Controllers
{
	...
	public class CustomerController : ControllerBase
	{
		...
		[HttpGet("{id}")]
		public async Task<ActionResult<GetCustomerResponse>> Get(Guid id, CancellationToken cancellationToken,
			[FromServices] IValidator<GetCustomerRequest> validator)
		{
		...
		[HttpDelete("{id}")]
		public async Task<ActionResult<DeleteCustomerDataRequest>> Delete(Guid id, CancellationToken cancellationToken, 
			[FromServices] IValidator<DeleteCustomerDataRequest> validator)
		{
