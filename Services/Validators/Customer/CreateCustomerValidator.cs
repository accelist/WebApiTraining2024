...
namespace Services.Validators.Customer
{
    public class CreateCustomerValidator : AbstractValidator<CreateCustomerRequest>
    {
        ...
        {
            _db = db;
            RuleFor(Q => Q.Name).NotEmpty().WithMessage("Name Cannot be empty").MaximumLength(50).WithMessage("Maximum 50 characters");

            RuleFor(Q => Q.Email).EmailAddress().NotEmpty().WithMessage("Email cannot be empty")
